...
- [DW2023 Warehouse Architecture](README.md)
- [How to Use This Book](about/how-to-use.md)
- [Documentation Standard](about/documentation-standard.md)

# 1. Architecture Overview

- [System Context](architecture/system-context.md)
- [Architecture View Catalog](architecture/view-catalog.md)
- [Current-State Overview](architecture/current-state.md)
- [Target-State Overview](architecture/target-state.md)
...
- [Domain Catalog](domains/domain-catalog.md)
- [Domain Documentation Template](domains/domain-template.md)

# 5. Security Architecture

- [Security and Trust Boundaries](security/trust-boundaries.md)
- [CUI and CMMC Scope](security/cui-cmmc-scope.md)
